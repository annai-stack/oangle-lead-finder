...
def find_accounts(client: anthropic.Anthropic, keys: dict, profile: dict, *,
    ...
    for i, acc in enumerate(accounts, 1):
        ...
        out.append({
            ...
            "sector":         acc.get("sector") or acc.get("industry") or enr.get("sector", ""),
            "company_size":   acc.get("company_size", ""),
            "location":       acc.get("location", ""),
            "market":         acc.get("market", market),
            "priority_band":  acc.get("priority_band", ""),
            "why_it_scores":  acc.get("why_it_scores") or enr.get("why_it_scores", ""),
            "likely_use_case": acc.get("likely_use_case") or enr.get("likely_use_case", ""),
